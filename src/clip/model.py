...
class VisualTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, loss_type="CLIP"):
...
class CLIP(nn.Module):
    ...
    def forward(self, image, text, loss_type):
        if image is None:
            ...
            return self.encode_image(image, loss_type)
        image_features = self.encode_image(image, loss_type)
        text_features = self.encode_text(text, loss_type)
